...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#d8e29d", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#d4bb88", input: "#d0bd97", primaryDark: "#0098A1", tertiary: "#b6bd88", text: "#632805", textDisabled: "#666171", textSubtle: "#cc594d", borderColor: "#524B63", card: "#f3e8d1", gradients: {
